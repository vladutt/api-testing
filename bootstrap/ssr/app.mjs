...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword.fdef78ed.mjs"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword.0b4f8abe.mjs"), "./Pages/Auth/Login.vue": () => import("./assets/Login.f8df91a1.mjs"), "./Pages/Auth/Register.vue": () => import("./assets/Register.af616dac.mjs"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword.c4a34904.mjs"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail.73eed6a9.mjs"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard.c4825b61.mjs"), "./Pages/Hosts.vue": () => import("./assets/Hosts.846e57ef.mjs"), "./Pages/Welcome.vue": () => import("./assets/Welcome.bafed7ae.mjs") })),
  setup({ el, app: app2, props, plugin }) {
    return createApp({ render: () => h$1(app2, props) }).use(plugin).use(I, Ziggy).mount(el);
  }
});
